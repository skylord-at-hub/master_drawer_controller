...
- Instead of using a declared table, use luac's sandbox memory to dump shortcut items and add a screen for players to add their own shortcuts instead of using the table (i.e. mem.drawer_shortcuts)
